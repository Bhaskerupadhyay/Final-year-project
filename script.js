// const destination = ["unvisited-Gokarna-karnataka", "unvisited-Guzez-valley-kashmir", "unvisited-kanatal-uttarakhand",
//                         "unvisited-sandakphu-Darjeeling","unvisited-Tada-falls-Andhra-pradesh","unvisited-Arch-Bridge-kerala"];
...
function changedestinationnext(){
    ...
    document.getElementById("slide-photo").src="./images/"+destination[i]+".jpg";
...
btn[0].onclick=function(){
   banner.src="images/ourvission-1.jpg";
...
btn[1].onclick=function(){
  banner.src="images/ourvission-2.jpg";

  animation_our_vision();
  this.classList.add("btn-dot-col");
}
btn[2].onclick=function(){
  banner.src="images/main-photo.jpeg";
  animation_our_vision();
